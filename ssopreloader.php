...
$target = new moodle_url('/mod/skillsoftmi/sso.php', array('a'=>$a));
$htmlbody = '<p>'.get_string('skillsoft_ssoloading', 'skillsoftmi').'&nbsp';
...
<p><?php echo get_string('skillsoft_ssoloading', 'skillsoftmi');?></p>
</body>
</html>